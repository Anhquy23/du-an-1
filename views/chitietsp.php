					...
					<div class="row">
						<div class="col-lg-3 thumbnails_col order-lg-1 order-2">
							<div class="single_product_thumbnails">
								<ul>
									<li><img src="views/images/<?= $onesp['img'] ?>" alt="" data-image="views/images/<?= $onesp['img'] ?>"></li>
									<li class="active"><img src="views/images/<?= $onesp['img'] ?>" alt="" data-image="views/images/<?= $onesp['img'] ?>"></li>
									<li><img src="views/images/<?= $onesp['img'] ?>" alt="" data-image="views/images/<?= $onesp['img'] ?>"></li>
								</ul>
							</div>
						</div>
